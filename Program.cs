...
public class Program
{
        ...
        do
        {
            ...
            switch (num)
            {
                ...
                case 2:
                    ...
                    doubleLinkedList.AddLast(std); // ضيف الطالب للقائمة
                    break;
                    ...
                    while (!flag)
                    {
                        switch (n)
                        {
                            case 1:
                                ...
                                doubleLinkedList.Print();
                                Sorting<DoubleLinkedList>.BubbleSortByFullName(doubleLinkedList);
                            ...
                            case 2:
                                Console.WriteLine("The Studets befor the sorting:");
                                doubleLinkedList.Print();
                                Sorting<DoubleLinkedList>.BubbleSortByOutcome(doubleLinkedList);
                                Console.WriteLine("The Students After Sorting:");
                                doubleLinkedList.Print();
                                flag = true;
                                break;
                ...
                case 4:
                    ...
                    List<Student>? students = Searching<DoubleLinkedList>.SearchByMark(mark, doubleLinkedList.Head);
                ...
                case 5:
                    List<Student>? stds = Searching<DoubleLinkedList>.StudentMoreTheMark(85, doubleLinkedList.Head);
                ...
                case 6:
                    ...
                    doubleLinkedList.DeleteByNumber(numb);
    ...
    // اعادة حل المسالة باللائحة الاحادية 
    public void Answer2()
    {
